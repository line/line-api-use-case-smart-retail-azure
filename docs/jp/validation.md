...
※ローカル環境構築の場合は、[フロントエンドの開発環境](frontend-devployment.md)の手順に従い、ローカルのURLを入れてください。
...
1. 【本番(Azure)環境構築/デプロイ】の手順にて保存しておいたAzure Static Web Appsのホスト名を 先頭にhttps:// を付けて以下のように記載し、更新を押下する。

...
(function (global, factory) {
	...
	(function (BrowserHelper) {
	  ...
	  function checkBrowserCompatibility() {
	    ...
	    if (!location.protocol.startsWith("http")) {
	      missingFeatures.push(exports.BrowserCompatibility.Feature.HTTP_PROTOCOL);
	      fullSupport = scannerSupport = false;
	    }

	    if (objectHasPropertyWithType(window, ["isSecureContext"], "boolean") && window.isSecureContext === false) {
	      missingFeatures.push(exports.BrowserCompatibility.Feature.SECURE_CONTEXT); // Don't disable full support in case browser is set to allow camera video streaming access in insecure contexts
	    }
	      ...
	      if (data[1] != null) {
	        switch (data[0]) {
	          ...
	          case "create-blurry-table-result":
	            ...
	            if ([exports.Barcode.Symbology.EAN8, exports.Barcode.Symbology.EAN13, exports.Barcode.Symbology.UPCA, exports.Barcode.Symbology.UPCE].includes(data[1])) {
	              this.readyBlurryRecognitionSymbologies.add(exports.Barcode.Symbology.EAN13);
	              this.readyBlurryRecognitionSymbologies.add(exports.Barcode.Symbology.EAN8);
	              this.readyBlurryRecognitionSymbologies.add(exports.Barcode.Symbology.UPCA);
	              this.readyBlurryRecognitionSymbologies.add(exports.Barcode.Symbology.UPCE);
	            } else if ([exports.Barcode.Symbology.CODE32, exports.Barcode.Symbology.CODE39].includes(data[1])) {
	              this.readyBlurryRecognitionSymbologies.add(exports.Barcode.Symbology.CODE32);
	              this.readyBlurryRecognitionSymbologies.add(exports.Barcode.Symbology.CODE39);
	            }
	          ...
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	                ...
	                browserName = exports.BrowserHelper.userAgentInfo.getBrowser().name;
	...
	BlurryRecognitionPreloader.availableBlurryRecognitionSymbologies = new set$1([exports.Barcode.Symbology.EAN13, exports.Barcode.Symbology.EAN8, exports.Barcode.Symbology.CODE32, exports.Barcode.Symbology.CODE39, exports.Barcode.Symbology.CODE128, exports.Barcode.Symbology.CODE93, exports.Barcode.Symbology.INTERLEAVED_2_OF_5, exports.Barcode.Symbology.MSI_PLESSEY, exports.Barcode.Symbology.UPCA, exports.Barcode.Symbology.UPCE]);
	...
	exports.ScanSettings = /*#__PURE__*/function () {
	  /**
	...
	})(exports.ScanSettings || (exports.ScanSettings = {}));
	...
	var Scanner = /*#__PURE__*/function () {
	  ...
	  function Scanner() {
	    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	        ...
	        scanSettings = _ref$scanSettings === void 0 ? new exports.ScanSettings() : _ref$scanSettings,
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              ...
	              case 3:
	                ...
	                _context.next = _context.t0 === exports.ImageSettings.Format.GRAY_8U ? 7 : _context.t0 === exports.ImageSettings.Format.RGB_8U ? 9 : _context.t0 === exports.ImageSettings.Format.RGBA_8U ? 11 : 13;
	                break;
	...
	(function (CameraAccess) {
	  ...
	  function getMainCameraForType(cameras, cameraType) {
	    ...
	    if (exports.BrowserHelper.isDesktopDevice()) {
	      ...
	      mainCameraForType = cameras[cameraType === exports.Camera.Type.FRONT ? 0 : cameras.length - 1];
	    } else {
	      mainCameraForType = cameras.filter(function (camera) {
	        return camera.cameraType === cameraType;
	  ...
	  function sortCamerasForCameraType(cameras, cameraType) {
	    ...
	    if (exports.BrowserHelper.isDesktopDevice()) {
	      ...
	      frontCameras = prioritizeMainCameraOverride(frontCameras, exports.Camera.Type.FRONT);
	      backCameras = prioritizeMainCameraOverride(backCameras, exports.Camera.Type.BACK);
	    } else if (cameras.every(function (camera) {
	      return camera.label === "";
	    })) {
	    ...
	    return cameraType === exports.Camera.Type.FRONT ? [].concat(toConsumableArray(frontCameras), toConsumableArray(backCameras)) : [].concat(toConsumableArray(backCameras), toConsumableArray(frontCameras));
	  }
	    ...
	    if (videoTracks.length !== 0) {
	      ...
	      if (typeof mediaStreamTrack.getSettings === "function") {
	        ...
	        if (((_mediaTrackSettings = mediaTrackSettings) === null || _mediaTrackSettings === void 0 ? void 0 : _mediaTrackSettings.facingMode) != null && mediaTrackSettings.facingMode.length > 0) {
	          camera.cameraType = mediaTrackSettings.facingMode === "environment" ? exports.Camera.Type.BACK : exports.Camera.Type.FRONT;
	        }
	      }
	  ...
	  function extractAccessibleCamerasFromDevices(devices) {
	    function createCamera(videoDevice, index, videoDevices) {
	      ...
	      if (!exports.BrowserHelper.isDesktopDevice() && videoDevices.every(function (device) {
	        ...
	        cameraType = videoDevices.length === 1 || index + 1 <= Math.floor(videoDevices.length / 2) ? exports.Camera.Type.FRONT : exports.Camera.Type.BACK;
	      } else {
	    ...
	    if (!exports.BrowserHelper.isDesktopDevice() && cameras.length > 1 && !cameras.some(function (camera) {
	      return camera.cameraType === exports.Camera.Type.BACK;
	    })) {
	...
	var CameraManager = /*#__PURE__*/function () {
	  function CameraManager(scanner, triggerFatalError, gui) {
	    ...
	    this.gui = gui;
	    this.cameraType = exports.Camera.Type.BACK;
	  }
	  ...
	  createClass(CameraManager, [{
	          ...
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	                ...
	                _context2.t0 = exports.CameraAccess;
	                _context2.next = 4;
	                return exports.CameraAccess.getCameras();
	          ...
	          while (1) {
	            switch (_context11.prev = _context11.next) {
	              ...
	              case 7:
	                ...
	                exports.CameraAccess.adjustCameraFromMediaStream(this.mediaStream, activeCamera);
	                ...
	                if (exports.BrowserHelper.isDesktopDevice()) {
	                  ...
	                  exports.CameraAccess.mainCameraForTypeOverridesOnDesktop.set(this.cameraType, activeCamera);
	                  exports.CameraAccess.mainCameraForTypeOverridesOnDesktop.set(activeCamera.cameraType, activeCamera);
	                }

	                if (!(cameras.length === 1 || exports.CameraAccess.getMainCameraForType(cameras, this.cameraType) === activeCamera)) {
	                  _context11.next = 24;
	                  break;
	                }
	    ...
	    value: function getInitialCameraResolutionConstraint() {
	      ...
	      switch ((_this$activeCameraSet = this.activeCameraSettings) === null || _this$activeCameraSet === void 0 ? void 0 : _this$activeCameraSet.resolutionPreference) {
	        case exports.CameraSettings.ResolutionPreference.ULTRA_HD:
	          cameraResolutionConstraint = CameraResolutionConstraint.ULTRA_HD;
	          break;

	        case exports.CameraSettings.ResolutionPreference.FULL_HD:
	          cameraResolutionConstraint = CameraResolutionConstraint.FULL_HD;
	          break;

	        case exports.CameraSettings.ResolutionPreference.HD:
	        default:
	        ...
	        return regenerator.wrap(function _callee12$(_context12) {
	          while (1) {
	            switch (_context12.prev = _context12.next) {
	              case 0:
	                cameras = exports.CameraAccess.sortCamerasForCameraType(cameras, this.cameraType);
	          ...
	          while (1) {
	            switch (_context25.prev = _context25.next) {
	              ...
	              case 7:
	                ...
	                _context25.next = 11;
	                return exports.CameraAccess.getCameras(true);
	              ...
	              case 11:
	                ...
	                exports.CameraAccess.markCameraAsInaccessible(camera);
	                throw error;
	          ...
	          while (1) {
	            switch (_context26.prev = _context26.next) {
	              ...
	              case 2:
	                ...
	                _context26.prev = 6;
	                _context26.next = 9;
	                return exports.CameraAccess.accessCameraStream(cameraResolutionConstraint, camera);
	              ...
	              case 19:
	                ...
	                this.mediaStream.getVideoTracks().forEach(function (track) {
	                  ...
	                  if (exports.BrowserHelper.userAgentInfo.getBrowser().name === "Safari") {
	...
	var GUI = /*#__PURE__*/function () {
	  ...
	  createClass(GUI, [{
	    ...
	    value: function setCameraType(cameraType) {
	      ...
	      (_this$cameraUploadInp = this.cameraUploadInputElement) === null || _this$cameraUploadInp === void 0 ? void 0 : _this$cameraUploadInp.setAttribute("capture", cameraType === exports.Camera.Type.FRONT ? "user" : "environment");
	    }
	  }, {
	          ...
	          while (1) {
	            switch (_context12.prev = _context12.next) {
	              case 0:
	                ...
	                singleImageModeDisallowed = singleImageModePlatformSettings.usageStrategy === exports.SingleImageModeSettings.UsageStrategy.NEVER;
	                singleImageModeForced = singleImageModePlatformSettings.usageStrategy === exports.SingleImageModeSettings.UsageStrategy.ALWAYS;
	                browserCompatibility = exports.BrowserHelper.checkBrowserCompatibility();
	...
	function getSchema() {
	  ...
	  return schema = freeze$1({
	    ...
	    [Attribute.CAMERA_TYPE]: {
	      type: "cameraType",
	      default: exports.Camera.Type.BACK
	    },
	    [Attribute.CONFIGURE]: {
	      type: "boolean",
	      default: true
	    ...
	    [Attribute.GUI_STYLE]: {
	      type: "guiStyle",
	      default: exports.BarcodePicker.GuiStyle.LASER
	    },
	    ...
	    [Attribute.VIDEO_FIT]: {
	      type: "videoFit",
	      default: exports.BarcodePicker.ObjectFit.CONTAIN
	    },
	    ...
	    [Attribute.SCAN_SETTINGS_CODE_DIRECTION_HINT]: {
	      type: "codeDirection",
	      default: exports.ScanSettings.CodeDirection.LEFT_TO_RIGHT
	    },
	...
	***************************************************************************** */
	...
	var Validator = /*#__PURE__*/function () {
	  ...
	  createClass(Validator, null, [{
	    ...
	    value: function isValidCameraType(value) {
	      return values$1(exports.Camera.Type).includes(value);
	    }
	  }, {
	    key: "isValidGuiStyle",
	    value: function isValidGuiStyle(value) {
	      return values$1(exports.BarcodePicker.GuiStyle).includes(value);
	    }
	  }, {
	    key: "isValidVideoFit",
	    value: function isValidVideoFit(value) {
	      return values$1(exports.BarcodePicker.ObjectFit).includes(value);
	    }
	  }, {
	    key: "isValidCodeDirection",
	    value: function isValidCodeDirection(value) {
	      return values$1(exports.ScanSettings.CodeDirection).includes(value);
	    }
	  }, {
	    key: "isArray",
	    ...
	    value: function getExpectationMessageForType(type) {
	      var messageByType = {
	        ...
	        videoFit: "Expected one of \"".concat(values$1(exports.BarcodePicker.ObjectFit).join('", "'), "\""),
	        ...
	        cameraType: "Expected one of \"".concat(values$1(exports.Camera.Type).join('", "'), "\""),
	        codeDirection: "Expected one of \"".concat(values$1(exports.ScanSettings.CodeDirection).join('", "'), "\""),
	        guiStyle: "Expected one of \"".concat(values$1(exports.BarcodePicker.GuiStyle).join('", "'), "\""),
	...
	var Controller = /*#__PURE__*/function () {
	  function Controller(view) {
	    ...
	    this.allSymbologies = values$1(exports.Barcode.Symbology).filter(function (s) {
	  ...
	  createClass(Controller, [{
	        ...
	        return regenerator.wrap(function _callee2$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              ...
	              case 6:
	                _context2.t0 = Proxy;
	                _context2.t1 = exports.BarcodePicker;
	              ...
	              case 41:
	                this.scanSettings = new exports.ScanSettings({
	    ...
	    value: function onScannerNewScanSettings(scanSettings) {
	      ...
	      var allSymbologies = values$1(exports.Barcode.Symbology).filter(function (s) {
	        return typeof s === "string";
	      });
	      ...
	      var changeSet = [{
	        ...
	        newValue: allSymbologies.reduce(function (enabledSymbologies, symbology) {
	          if (scanSettings.isSymbologyEnabled(symbology)) {
	            enabledSymbologies.push(exports.Barcode.Symbology.toJSONName(symbology));
	          }
	            ...
	            switch (_context4.prev = _context4.next) {
	              case 0:
	                ...
	                if (this.lazyAttributeConverter[Attribute.SINGLE_IMAGE_MODE_SETTINGS] != null) {
	                  ...
	                  settings.desktop = _objectSpread$2(_objectSpread$2({}, exports.SingleImageModeSettings.defaultDesktop), (_this$lazyAttributeCo = this.lazyAttributeConverter[Attribute.SINGLE_IMAGE_MODE_SETTINGS].desktop) !== null && _this$lazyAttributeCo !== void 0 ? _this$lazyAttributeCo : {});
	                  settings.mobile = _objectSpread$2(_objectSpread$2({}, exports.SingleImageModeSettings.defaultMobile), (_this$lazyAttributeCo2 = this.lazyAttributeConverter[Attribute.SINGLE_IMAGE_MODE_SETTINGS].mobile) !== null && _this$lazyAttributeCo2 !== void 0 ? _this$lazyAttributeCo2 : {});
	...
	exports.userLicenseKey = void 0;
	/**
	 * @hidden
	 */

	exports.scanditEngineLocation = void 0;
	/**
	 * @hidden
	 */
	...
	exports.configurePromise = void 0;
	/**
	 * @hidden
	...
	function configure(licenseKey) {
	  ...
	  exports.configurePromise = new promise$1( /*#__PURE__*/function () {
	        ...
	        while (1) {
	          switch (_context.prev = _context.next) {
	            ...
	            case 12:
	              ...
	              _context.next = 15;
	              return exports.blurryRecognitionPreloader.prepareBlurryTables();
